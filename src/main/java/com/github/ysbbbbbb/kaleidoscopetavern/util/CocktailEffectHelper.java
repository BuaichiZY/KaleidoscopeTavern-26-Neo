...
public class CocktailEffectHelper {
     ...
     */
    public static CollectedData collectFromStorage(HolderLookup.Provider registries, ItemStackHandler storage) {
        ...
        for (int i = 0; i < storage.getSlots(); i++) {
            ...
            if (brewLevel > 0) {
                effects.addAll(DrinkEffectResolver.entriesFor(registries, ingredient, brewLevel));
            }
        }
